...
export default function DocumentRow({ doc }: Props) {
  ...
  const catClass =
    categoryColor[doc.category] ?? "bg-gray-50 text-gray-600 border-gray-200";
    ...
    <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs text-[#546a2f] hover:bg-[#546a2f]/10 px-3 py-1.5 rounded transition-colors font-medium disabled:opacity-40 disabled:cursor-not-allowed"
        >
